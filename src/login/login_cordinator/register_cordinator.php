...
if (!empty($_POST['name_estate_cordinator']) && !empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['cordinator_job']) && isset($_POST['email']) && isset($_POST['no_telp']) && isset($_FILES['foto_profile'])) {
	...
	if (in_array($file_extension, $valid_ext)) {
		...
		echo json_encode('extension tidak valid');
	}
}
