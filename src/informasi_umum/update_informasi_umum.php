...
if (!empty($_POST['id_writer']) && isset($_POST['id_informasi_umum']) && isset($_POST['caption'])  && isset($_POST['content'])) {
    $idWriter = $_POST['id_writer'];
    $id = $_POST['id_informasi_umum'];
    ...
    $result = $db->update('tb_informasi_umum', 'url_news_image = "' . $ubah . '", caption = "' . $caption . '", content = "' . $content . '", update_by = "' . $dataUser . '", update_at = "' . $thisTime . '"', 'id_informasi_umum = "' . $id . '"');
